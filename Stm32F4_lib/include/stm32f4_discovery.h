 ...
 */
typedef enum {
	LED4 = 0, LED3 = 1, LED5 = 2, LED6 = 3, LED7 = 4
} Led_TypeDef;
...
typedef enum {
	COM1 = 0, COM2 = 1, COM3 = 2, COM4 = 3, COM5 = 4, COM6 = 5,
} COM_TypeDef;
...
#define LED7_PIN                         GPIO_Pin_12			//Светодиод на китайской плате
#define LED7_GPIO_PORT                   GPIOB
#define LED7_GPIO_CLK                    RCC_AHB1Periph_GPIOB
